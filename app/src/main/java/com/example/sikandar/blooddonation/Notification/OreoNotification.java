...
public class OreoNotification extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.example.sikandar.blooddonation";
    private static final String CHANNEL_NAME = "blooddonation";
    ...
    @TargetApi(Build.VERSION_CODES.O)
    public Notification.Builder getNotification(String title, String body, PendingIntent pendingIntent,
